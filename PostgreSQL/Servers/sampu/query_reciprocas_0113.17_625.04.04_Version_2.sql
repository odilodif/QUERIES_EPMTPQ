WITH base_movimiento AS (
    SELECT 
        ...
        --COALESCE(prov.ruc_stepro, '9999999999999') AS ruc,
				'9999999999999' AS ruc,
        --COALESCE(prov.nombre_tepro, 'VARIOS CLIENTES') AS nombre_tepro,
    ...
    WHERE mov.mov_fecha_comov BETWEEN '2025-12-01' AND '2025-12-31'  
),
presupuesto_data AS (
    SELECT 
        pmes.ide_codem,
