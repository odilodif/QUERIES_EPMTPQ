-- DROP FUNCTION  "public"."fn_reporte_reciprocas_presupuesto_113_19_00__625_22_01__625_24_99" (date, date, varchar, varchar, varchar, varchar);

CREATE OR REPLACE FUNCTION  "public"."fn_reporte_reciprocas_presupuesto_113_19_00__625_22_01__625_24_99"( p_fechaini DATE,  p_fechafin DATE, p_cta_mayor_pagar_cobrar VARCHAR, p_codigo_clasificador_prcla VARCHAR, p_cta_mayor_gasto_i VARCHAR, p_tercer_digito VARCHAR )
RETURNS TABLE (
    res_periodo INT,
...
FROM (
    ...
    SELECT 
       ...
       COALESCE(pre.codigo_clasificador_prcla,p_codigo_clasificador_prcla)::VARCHAR AS codigo_clasificador_prcla, 
        COALESCE(SUBSTRING(c.cue_codigo_cocac FROM 1 FOR 9)  , '625.24.99')::VARCHAR AS cta_mayor_gasto_i,
        0 AS flujo_deudor2,
    ...
    LEFT JOIN LATERAL (
        ...
        WHERE dm_c.ide_comov = dmov.ide_comov 
          ...
          AND (cc_c.cue_codigo_cocac LIKE '625.22%' /*OR cc_c.cue_codigo_cocac LIKE '625.24%' */ )
    ...
    WHERE cat.cue_codigo_cocac LIKE '113.19%' 
...
--SELECT * FROM fn_reporte_reciprocas_presupuesto_113_19_00__625_22_01__625_24_99('2025-11-01', '2025-11-30', '113.19.00','19.04.99','625.24.00','.99');
