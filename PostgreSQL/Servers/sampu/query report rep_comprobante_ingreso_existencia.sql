...
ingreso.numero_proceso_ingeg,
(SELECT gth_empleado1.primer_nombre_gtemp ||' ' || gth_empleado1.segundo_nombre_gtemp ||' ' || gth_empleado1.apellido_paterno_gtemp ||' ' || gth_empleado1.apellido_materno_gtemp 
FROM gth_empleado gth_empleado1 WHERE gth_empleado1.ide_gtemp = ingreso.ide_gtemp_adminc) AS nombre_completo,
(SELECT documento_identidad_gtemp as document_legal  FROM gth_empleado WHERE ide_gtemp = ingreso.ide_gtemp_adminc) as cedula
...
WHERE ingreso.ide_ingeg =4 

/*******************************/

SELECT gth_empleado1.primer_nombre_gtemp ||' ' || gth_empleado1.segundo_nombre_gtemp ||' ' || gth_empleado1.apellido_paterno_gtemp ||' ' || gth_empleado1.apellido_materno_gtemp as complete_name  
FROM gth_empleado gth_empleado1 WHERE gth_empleado1.ide_gtemp = 13
SELECT documento_identidad_gtemp as document_legal  FROM gth_empleado WHERE ide_gtemp = 13