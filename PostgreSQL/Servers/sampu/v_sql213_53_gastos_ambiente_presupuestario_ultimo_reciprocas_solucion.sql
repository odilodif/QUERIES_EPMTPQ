--DROP VIEW v_sql213_53_gastos_ambiente_presupuestario

 CREATE VIEW v_sql213_53_gastos_ambiente_presupuestario
 AS
...
GROUP BY 
    ...
    fecha_venc;
		...
		/**************************************/
		SELECT * FROM v_sql213_53_gastos_ambiente_presupuestario
