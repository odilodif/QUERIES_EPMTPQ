--DROP VIEW v_gastos_ambiente_presupuestario
CREATE VIEW v_gastos_ambiente_presupuestario
AS
SELECT
prestr.ide_comov,
prestr.ide_gelua, 
...
FROM 	(
										...
										and (cue_codigo_cocac like '131%'
															or cue_codigo_cocac like '134%'
															or cue_codigo_cocac like '141%'
															or cue_codigo_cocac like '142%'
															or cue_codigo_cocac like '152%'
															or cue_codigo_cocac like '223%'
															or cue_codigo_cocac like '634%'
															or cue_codigo_cocac like '635%'
															or cue_codigo_cocac like '636%')
										left join
														(   select ide_codem,														
																codigo_clasificador_prcla,
				...
				GROUP BY prestr.cue_codigo_cocac ,prestr.ide_comov,prestr.ide_gelua, prestr.codigo_clasificador_prcla