...
FROM (
   ...
   SELECT 
        ...
        '113.97.00' AS cta_mayor_pagar_cobrar,
        dmov.debe_codem AS flujo_deudor,
        0 AS flujo_acreedor,
        b.ruc, b.nombre_tepro,
        COALESCE(pre.codigo_clasificador_prcla, '38.01.07') AS codigo_clasificador_prcla, 
    ...
    LEFT JOIN LATERAL (
        ...
        WHERE dm_c.ide_comov = dmov.ide_comov 
          ...
          AND (cc_c.cue_codigo_cocac LIKE '124.97%' /*OR cc_c.cue_codigo_cocac LIKE '625.24%' */ )
    ...
    WHERE cat.cue_codigo_cocac LIKE '113.97%' 
