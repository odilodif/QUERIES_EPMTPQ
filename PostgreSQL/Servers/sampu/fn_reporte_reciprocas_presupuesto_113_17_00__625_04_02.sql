...
CREATE OR REPLACE FUNCTION "public"."fn_reporte_reciprocas_presupuesto_113_17_00__625_04_02"(
    p_fechaini DATE, 
    p_fechafin DATE, 
...
FROM (
    ...
    SELECT 
        ...
        COALESCE(SUBSTRING(c.cue_codigo_cocac FROM 1 FOR 9)  , '625.02.02')::VARCHAR AS cta_mayor_gasto_i,
        0 AS flujo_deudor2,
    ...
    LEFT JOIN LATERAL (
        ...
        WHERE dm_c.ide_comov = dmov.ide_comov 
          ...
          AND (cc_c.cue_codigo_cocac LIKE '625.02%' OR cc_c.cue_codigo_cocac LIKE '625.04%' )
...
--SELECT * FROM fn_reporte_reciprocas_presupuesto_113_17_00__625_04_02('2025-12-01', '2025-12-31', '113.17.00','17.02.02','625.04.00','.99');
