-- DROP FUNCTION f_calcule_projection_percentage_80(INTEGER , date)
CREATE OR REPLACE FUNCTION f_calcule_projection_percentage_80 (crs_id  INT DEFAULT 0, date_projection date DEFAULT '1900-01-01')  RETURNS SETOF  projection_percentage
	AS $BODY$
	DECLARE 
...
select f_calcule_projection_percentage_80(0,'2021-09-01');