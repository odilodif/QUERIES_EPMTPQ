...
CREATE OR REPLACE FUNCTION  "public"."fn_reporte_reciprocas__113_97_00__625_22_01__625_24_99"( p_fechaini DATE,  p_fechafin DATE, p_cta_mayor_pagar_cobrar VARCHAR, p_codigo_clasificador_prcla VARCHAR, p_cta_mayor_gasto_i VARCHAR, p_tercer_digito VARCHAR )
RETURNS TABLE (
    res_periodo INT,
...
--SELECT * FROM fn_reporte_reciprocas__113_97_00__625_22_01__625_24_99('2025-11-01', '2025-11-30', '113.97.00','38.01.07','00.00.00','00.00');
