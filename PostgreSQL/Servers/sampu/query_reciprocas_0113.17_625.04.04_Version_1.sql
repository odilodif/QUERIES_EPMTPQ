WITH base_movimiento AS (
    ...
    WHERE mov.mov_fecha_comov BETWEEN '2025-12-01' AND '2025-12-31'  and  cp.ide_tecpo = 1751
),
presupuesto_data AS (
...
SELECT 
    ...
    '2025-12-01' AS fecha_apro,
    '2025-12-31' AS fecha_venc
FROM (
    ...
    SELECT 
        ...
        b.ruc, 
				b.nombre_tepro,
        COALESCE(pre.codigo_clasificador_prcla, '17.02.02') AS codigo_clasificador_prcla, 
    ...
    LEFT JOIN LATERAL (
        ...
        WHERE dm_c.ide_comov = dmov.ide_comov 
          ...
          AND (cc_c.cue_codigo_cocac like '625.04%'       )
