...
--DROP function f_calcule_porcentage_and_get_table_elapsed_percentage(integer);
...
_query= 'SELECT * FROM detention_all'; 
	FOR _date_inq, _yearsq, _monthsq, _daysq, _prontuarioq, _name_pplq,_last_name_pplq, _number_dtq, _name_crsq,_crs_idq   IN EXECUTE _query LOOP
			...
			END LOOP;	
	RETURN QUERY	 
 SELECT * FROM porcentaje_cumplido WHERE porcent_cumplido BETWEEN 60 AND 69;
...
SELECT f_calcule_porcentage_and_get_table_elapsed_percentage60(10744);
