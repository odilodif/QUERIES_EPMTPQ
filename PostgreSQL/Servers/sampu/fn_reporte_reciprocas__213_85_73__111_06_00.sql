-- DROP FUNCTION  "public"."fn_reporte_reciprocas__213_85_73__111_06_00" (date, date, varchar, varchar, varchar, varchar);

CREATE OR REPLACE FUNCTION  "public"."fn_reporte_reciprocas__213_85_73__111_06_00"( p_fechaini DATE,  p_fechafin DATE, p_cta_mayor_pagar_cobrar VARCHAR, p_codigo_clasificador_prcla VARCHAR, p_cta_mayor_gasto_i VARCHAR, p_tercer_digito VARCHAR )
RETURNS TABLE (
    res_periodo INT,
...
FROM (
    ...
    WHERE cat.cue_codigo_cocac LIKE '213.85.73%' 
    ...
    SELECT 
        ...
        ' ' AS codigo_clasificador_prcla,
        '224.85.73' AS cta_mayor_gasto_i,
...
--SELECT * FROM fn_reporte_reciprocas__213_85_73__111_06_00('2025-11-01', '2025-11-30', '213.85.73','00.00.00','00.00.00','00.00');